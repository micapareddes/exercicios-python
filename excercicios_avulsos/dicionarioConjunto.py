...
def valid_cpf(key):
    while True:
        ...
        elif key in student_database.keys():
            print()
...
def valid_age(age):
    while True:
        try:
            ...
            print()
            age = input('Por favor, insira um número válido para a idade: ')
...
def cpf_in_database(cpf):
    while cpf not in student_database.keys():
        print()
...
student_database = {
    ...
    '12345678988': ('Gordo Akali', 4, 'Gatitos Fofinhos', ['Como bagunçar a caix de areia', 'Beijinhos Asperos', 'MiauMiau'])
    }
...
while menu:
    ...
    if action == 1:
        ...
        while continue_enrolling == 'sim':
            ...
            continue_enrolling = input('Digite "sim" se deseja continuar excluindo cadastros: ')
